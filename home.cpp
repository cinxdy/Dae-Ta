...
int Home::goToTable(Location dest)
{
    ...
    while (true)
    {
        ...
        if (locationX == destTable[dest]->x)
            break;
        else if (locationX < destTable[dest]->x)
            locationX++;
        else
            locationX--;
    ...
    while (true)
    {
        ...
        if (interrupted == 0)
        {
            if (locationY == destTable[dest]->y)
                break;
            else if (locationY < destTable[dest]->y)
                locationY++;
            else
                locationY--;
        }
